...
public class App {
  public static void main(String[] args) {
    ...
    while(programRunning){
      System.out.println("Welcome to our car dealership. What would you like to do? Enter one of the following options: All Vehicles, Search Price, Add Vehicle, Exit");
